...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public List<Double> longitudeLocationList, latitudeLocationList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        longitudeLocationList = new ArrayList<>();
        latitudeLocationList = new ArrayList<>();
    ...
    public void storeCurrentLocationInList(){
        longitudeLocationList.add(longitudeCurrentPosition);
        latitudeLocationList.add(latitudeCurrentPosition);
    }
